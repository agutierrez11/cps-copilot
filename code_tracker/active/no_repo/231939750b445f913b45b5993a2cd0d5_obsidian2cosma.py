Ä…"""Convert an Obsidian vault into a collection of Markdown notes readable by Cosma (https://cosma.graphlab.fr/en/)
...
def copy_system_birthtime(source, destination):
  ...
  # On Windows, we can't easily set birthtime, but we can set access/mod times
  if platform.system() == 'Windows':
...
def rename_file(file):
  ...
  # Remove accents
  new_filename = unicodedata.normalize("NFD", filename).encode("ascii", "ignore").decode("utf-8")
  ...
  if filename != new_filename:
    ...
    try:
      ...
      printv(f"Error renaming {file} to {new_path}: {e}")
...
if __name__ == "__main__":
  main()
÷ *cascade08÷î*cascade08î„' *cascade08„'ý'*cascade08ý'­x *cascade08­x‹|*cascade08‹|Ä… *cascade082hfile:///c:/Users/Antonio/OneDrive/Escritorio/Ecosistema_Fintech_Global/cosma_workspace/obsidian2cosma.py